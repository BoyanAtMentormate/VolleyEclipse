...
public class GalleryAdapter extends BaseAdapter {
    ...
    private int mStartAtResultItem = 0;
    private static final int ITEMS_TO_SKIP = 4;
    ...
    public void loadMoreData() {
        mStartAtResultItem += ITEMS_TO_SKIP;
        String url = Constants.BASE_URL + "&start=" + mStartAtResultItem;
    ...
    public void requestImage(final ImageView niv, final String imgUrl) {
        ...
        request.setTag(Constants.TAG_IMAGE_REQUEST);
    ...
    private boolean closeToEnd(long position) {
        int max = mStartAtResultItem < 1 ? Constants.MAX_IMAGES_PER_LOAD : mStartAtResultItem;

...
import com.example.volleysimplesample.util.RegexUtil;
    ...
    public void onCreate() {
        ...
        mImageCache = new ImageLoader.ImageCache() {
            ...
            public void putBitmap(String url, Bitmap bitmap) {
            	url = RegexUtil.sanitizeKey(url);
            	Log.d(Constants.TAG_MEMORY_CACHE, "Memory cache put for image : " + url);
            ...
            public Bitmap getBitmap(String url) {
            	url = RegexUtil.sanitizeKey(url);
                Log.d(Constants.TAG_MEMORY_CACHE, "Memory cache get for image : " + url);
        ...
        mDiskCache = new ImageLoader.ImageCache() {
            ...
            public void putBitmap(String url, Bitmap bitmap) {
            	url = RegexUtil.sanitizeKey(url);
            	Log.d(Constants.TAG_DISK_CACHE, "Disk cache hit for image : " + url);
            ...
            public Bitmap getBitmap(String url) {
                ...
                if(entry == null) {
                    ...
                    Log.d(Constants.TAG_DISK_CACHE, "Disk cache get for image : " + url);
                }
